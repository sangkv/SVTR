...
class SVTR(nn.Module):
    def __init__(self,num_classes, img_size=(32, 1024), input_channel=1, max_seq_len=256, out_channels=192):
        super().__init__()
        self.encoder = SVTREncoder(img_size=img_size, in_channels=input_channel, max_seq_len=max_seq_len, out_channels=out_channels)
    ...
    def forward(self, input):
        ...
        prediction = self.fc(visual_feature)
